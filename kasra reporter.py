...
try:
    ...
    bot = pyrubi.Client("سید حجت موسوی")
    font = pyfiglet.Figlet()
    n = 0
    Cl()

    print(colorama.Fore.LIGHTBLACK_EX + font.renderText(" Kasra hacker "))
    print(colorama.Fore.CYAN + " Tel >>> @khaleq_haacker\n\n")
    time.sleep(1)
    ...
    Li = input(f" \n{colorama.Fore.YELLOW} Your Link or ID : ")
